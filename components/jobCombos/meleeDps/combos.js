    ...
    if (jobName === 'monk') {
      ...
      return (
        <div className={classPageStyles.divComboNoVideo}>
          ...
          <div className={classPageStyles.divInfo}>
            <h2>Normal Combo</h2>
            <div>Ninjas normal 1-2-3 is <b>Spinning Edge</b> - <b>Gust Slash</b> - <b>Aeolian Edge</b> (rear).</div>
            <div>Ninjas use ninjutsus called mudras for a myriad of purposes, and one of them is a buff that will reduce weaponskill cooldowns. We will need to use <b>Huton</b>, which will require us to use 3 mudras and end on the Ten mudra.</div>
          </div>
        </div>
      )
    } else if (jobName === 'samurai') {
    ...
    if (jobName === 'monk') {
      return (
        <div className={classPageStyles.divComboNoVideo}>
          ...
          <div className={classPageStyles.divInfo}>
            ...
            <div>In dungeon packs, we will do similar things to our single target moves. <b>Arm of the Destroyer</b> changes our form to raptor, followed up with <b>Four-point Fury</b> to change to Coeurl form, and finished up with <b>Rockbreaker</b>.</div>
          </div>
        </div>
      )
    } else if (jobName === 'ninja') {
      ...
      return (
        <div className={classPageStyles.divComboNoVideo}>
          ...
          <div className={classPageStyles.divInfo}>
            <h2>Dungeon Combos</h2>
            <div>Samurais in dungeon packs will utilize two different combos in order to gather 2 different Sens in order to use a final move. Start with <b>Fuga</b> and then use either <b>Mangetsu</b> for Getsu, or <b>Oka</b> for Ka Sen. Once we have our two sen, use <b>Iaijutsu</b>, and execute <b>Tenka Goken</b>.</div>
            <div>Weave in <b>Hissatsu: Guren</b>, <b>Hissatsu: Kyuten</b> when you have the Kenki Gauge for it.</div>
          </div>
        </div>
      )
    } else if (jobName === 'dragoon') {
      ...
      return (
        <div className={classPageStyles.divComboNoVideo}>
          ...
          <div className={classPageStyles.divInfo}>
            <h2>Dungeon Combos</h2>
            <div>For dungeons, use <b>Spinning Scythe</b> with <b>Nightmare Scythe</b>. Use <b>Whorl of Death</b> to increase damage you do to the pack. At 50 soul gauge, use <b>Grim Swathe</b> with <b>Guillotine</b>.</div>
          </div>
        </div>
      )
    }
