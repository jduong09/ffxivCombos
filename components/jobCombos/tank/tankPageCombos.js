...
import classPageSyles from '@/app/jobs/classPage.module.css'
...
const TankPageCombos = ({ jobName, normalArray, burstArray, dungeonArray }) => {
  ...
  const renderBurstDiv = () => {
    if (jobName === "gunbreaker") {
      return (
        <div className={classPageSyles.divComboWithVideo}>
          <div className={classPageSyles.divInfo}>
  ...
  const renderNormalDiv = () => {
    if (jobName === "gunbreaker") {
      return (
        <div className={classPageSyles.divComboNoVideo}>
          <ul className={classPageSyles.listJobAction}>{listItemsNormal}</ul>
          <div className={classPageSyles.divInfo}>
            <h2>Normal Combo</h2>
      ...
      return (
        <div className={classPageSyles.divComboNoVideo}>
          <ul className={classPageSyles.listJobAction}>{listItemsNormal}</ul>
          <div className={jobclassPageSylesStyles.divInfo}>
            <h2>Normal Combo</h2>
  ...
  const renderDungeonDiv = () => {
    if (jobName === "gunbreaker") {
      return (
        <div className={classPageSyles.divComboNoVideo}>
          <ul className={classPageSyles.listJobAction}>{listItemsDungeon}</ul>
          <div className={classPageSyles.divInfo}>
  ...
  return (
    <div className={classPageSyles.divMainContainer}>
      {renderBurstDiv()}
      {renderNormalDiv()}
      {renderDungeonDiv()}
    </div>
