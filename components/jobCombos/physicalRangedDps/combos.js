    ...
    if (jobName === "machinist") {
      return (
        <div className={classPageStyles.divComboWithVideo}>
          <div className={classPageStyles.divInfo}>
            ...
            <div>Machinist burst phase revolves around the skill <b>Wildfire</b>. For 10 seconds, you need to execute 6 actions for a total of 1440 potency. The 6 actions are usually <b>Heat Blast</b> and <b>Gauss Round</b>, because <b>Heat Blast</b> will reduce the recast time of <b>Gauss Round</b>.</div>
            <div>Therefore we will either have 50 heat in the gauge in order to use <b>Hypercharge</b>, or we can use <b>Barrel Stabilizer</b> to increase our heat gauge by 50. Apply <b>Wildfire</b> to the target, and begin using Heat Round, and Gauss Round when you have one available. This should be enough to get maximum potency out of <b>Wildfire</b></div>
            <div>Once the 10 seconds of <b>Wildfire</b> is up, we can use <b>Reassemble</b> with <b>Drill</b> during burst to guarentee maximum damage. Use <b>Chain Saw</b> and <b>Air Anchor</b> when it is off cooldown.</div>
      ...
      return (
        <div className={classPageStyles.divComboWithVideo}>
          <div className={classPageStyles.divInfo}>
            <h2>2 Minute Window</h2>
            <div>In burst phase, Dancer will need to maintain their standard finish buff. Start with <b>Devilment</b> to buff you and your dance partner. <b>Starfall Dance</b> to start, followed by <b>Technical Step</b>. Do the corresponding dances, and stop at 4 steps, and use <b>Technical Finish</b>.</div>
    ...
    if (jobName === "machinist") {
      return (
        <div className={classPageStyles.divComboNoVideo}>
          ...
          <div className={classPageStyles.divInfo}>
            <h2>Normal Combo</h2>
            <div>Machinist normal combo is <b>Split Shot</b> - <b>Slug Shot</b> - <b>Clean Shot</b>. Performing this combo will gradually increase the heat and battery gauge. In between this combo, Machinist should try to weave in the AOE attack <b>Ricochet</b> and ST attack <b>Gauss Round</b> for extra damage.</div>
            <div>When not in burst, Machinist can use <b>Drill</b> once before it is needed for the burst phase. <b>Air Anchor</b> and <b>Chain Saw</b> fuel the battery gauge, and should be used when its immediately off cooldown.</div>
          </div>
        </div>
      )
    } else if (jobName === "bard") {
      ...
      return (
        <div className={classPageStyles.divComboNoVideo}>
          ...
          <div className={classPageStyles.divInfo}>
            ...
            <div>In dungeons, our AOE will be <b>Spread Shot</b>/<b>Scatter Gun</b>. There is no combo action, but when we have casts of <b>Ricochet</b>, use them because it is an AOE attack.</div>
            <div>Manage your heat gauge, and if you can afford it use <b>Hypercharge</b>, in order to then use <b>Auto Crossbow</b>. The AOE oGCD is <b>Bioblaster.</b></div>
          </div>
        </div>
      )
    } else if (jobName === "bard") {
